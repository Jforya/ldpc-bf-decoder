...
FILE_FOLDER = './base_matrix/2k/'

data_path = strcat(FILE_FOLDER,FILE_NAME); 
%'./base_matrix/2k/qc_peg_16_145_invc6dplopt_shift_inv.txt';
...
q = 129 ;
BLOCK_SIZE = q-1;   %子矩阵大小 128
H1_NUM_WIDTH = 5;
BLK_SIZE_WIDTH = 8;%128
COL_WEIGHT = 4;
...
H2_mat_origin_exp = func_gen_h_128(H2_data_origin,q-1);				% H2 扩展为元素为0/1的完整矩阵
% % 
...
H1_mat_exp = func_gen_h_128(H1_data,q-1);				% H1 扩展为元素为0/1的完整矩阵
H2_mat_exp = func_gen_h_128(H2_data,q-1);				% H2 扩展为元素为0/1的完整矩阵

[flag1 ,H2_mat_exp_inv] = func_inv2 (H2_mat_exp) ;  % H2逆

%-------------------------H1_value.coe------------------------
H1_coe_path = strcat('./gen_coe/2k/128_1_H1_value_',num2str(ROWNUM),'.coe') 
%'./gen_coe/2k/128_1_H1_value_16.coe' ;
...
%-------------------------H2_value.coe------------------------
H2_coe_path = strcat('./gen_coe/2k/128_1_H2_value_',num2str(ROWNUM),'.coe')
%'./gen_coe/2k/128_1_H2_value_16.coe' ;
...
%-------------------------H2_inv_value.coe------------------------
H2_inv_coe_path = strcat('./gen_coe/2k/128_1_H2_inv_value_',num2str(ROWNUM),'.coe') 
%'./gen_coe/2k/128_1_H2_inv_value_16.coe' ;
